"""
Serviço de exercícios do SmartSaúde.
Este módulo configura e inicia o serviço de exercícios usando FastAPI.
"""
...
def create_app() -> FastAPI:
    """
    Cria e configura a aplicação FastAPI para o serviço de exercícios.
