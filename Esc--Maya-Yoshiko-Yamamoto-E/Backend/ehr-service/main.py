"""
Serviço de Registros Eletrônicos de Saúde (EHR) do SmartSaúde.
Este módulo configura e inicia o serviço de EHR usando FastAPI.
"""
...
def create_app() -> FastAPI:
    """
    Cria e configura a aplicação FastAPI para o serviço de EHR.
